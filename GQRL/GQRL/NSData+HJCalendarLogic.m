...
@implementation NSData (HJCalendarLogic)
...
{
    NSUInteger weekday = [self weeklyOrdinality];
...
-(NSString *)compareIfTodayWithDate
{
    ...
    if (comps_today.year == comps_other.year &&
        ...
        return [self getWeekStringFromInteger:weekIntValue];//周几
    }
}
